        ...
        <CardContent>
          <div className="space-y-3">
            {alertas.map((alerta) => (
              <div
                key={alerta.id}
                className={`p-4 rounded-lg border transition-all ${alerta.lido ? "border-border hover:bg-muted/30" : "bg-muted/50 border-primary"
                  }`}
              >
                <div className="flex items-start gap-4">
                  <div
                    className={`h-10 w-10 rounded-full flex items-center justify-center flex-shrink-0 ${alerta.severidade === "alta"
                        ? "bg-destructive/10"
