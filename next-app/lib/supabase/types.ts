...
export type Database = {
    ...
    public: {
        Tables: {
            ...
            construtora_convites: {
                ...
                Relationships: [
                    ...
                    },
                    {
                        ...
                        columns: ["construtora_id"]
                        isOneToOne: false
                        referencedRelation: "construtoras_public"
                        referencedColumns: ["id"]
                    },
                ]
            }
            ...
            fornecedor_entregas: {
                ...
                Relationships: [
                    ...
                    {
                        foreignKeyName: "fornecedor_entregas_obra_id_fkey"
                        columns: ["obra_id"]
                        isOneToOne: false
                        referencedRelation: "obras"
                        referencedColumns: ["id"]
            ...
            obra_imprevistos: {
                ...
                Relationships: [
                    {
                        foreignKeyName: "obra_imprevistos_obra_id_fkey"
                        columns: ["obra_id"]
                        isOneToOne: false
                        referencedRelation: "obras"
                        referencedColumns: ["id"]
        ...
        Enums: {
            ...
            user_role: "admin" | "engenheiro" | "gestor" | "usuario"
        }
        CompositeTypes: {
            [_ in never]: never
        }
